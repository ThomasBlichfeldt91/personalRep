...
void OPCN2::setup(uint8_t chip_select)
{
    _CS = chip_select;
...
struct HistogramData OPCN2::read_histogram(bool convert_to_conc)
{
  ...
  data.bin0   = (double)this->_16bit_int(vals[0], vals[1]) / conv; data.allData[4] = data.bin0;
  data.bin1   = (double)this->_16bit_int(vals[2], vals[3]) / conv; data.allData[5] = data.bin1;
  data.bin2   = (double)this->_16bit_int(vals[4], vals[5]) / conv; data.allData[6] = data.bin2;
  data.bin3   = (double)this->_16bit_int(vals[6], vals[7]) / conv; data.allData[7] = data.bin3;
  data.bin4   = (double)this->_16bit_int(vals[8], vals[9]) / conv; data.allData[8] = data.bin4;
  data.bin5   = (double)this->_16bit_int(vals[10], vals[11]) / conv; data.allData[9] = data.bin5;
  data.bin6   = (double)this->_16bit_int(vals[12], vals[13]) / conv; data.allData[10] = data.bin6;
  data.bin7   = (double)this->_16bit_int(vals[14], vals[15]) / conv; data.allData[11] = data.bin7;
  data.bin8   = (double)this->_16bit_int(vals[16], vals[17]) / conv; data.allData[12] = data.bin8;
  data.bin9   = (double)this->_16bit_int(vals[18], vals[19]) / conv; data.allData[13] = data.bin9;
  data.bin10  = (double)this->_16bit_int(vals[20], vals[21]) / conv; data.allData[14] = data.bin10;
  data.bin11  = (double)this->_16bit_int(vals[22], vals[23]) / conv; data.allData[15] = data.bin11;
  data.bin12  = (double)this->_16bit_int(vals[24], vals[25]) / conv; data.allData[16] = data.bin12;
  data.bin13  = (double)this->_16bit_int(vals[26], vals[27]) / conv; data.allData[17] = data.bin13;
  data.bin14  = (double)this->_16bit_int(vals[28], vals[29]) / conv; data.allData[18] = data.bin14;
  data.bin15  = (double)this->_16bit_int(vals[30], vals[31]) / conv; data.allData[19] = data.bin15;
  ...
  data.pm1 = this->_calculate_float(vals[50], vals[51], vals[52], vals[53]); data.allData[0] = data.pm1;
  data.pm25 = this->_calculate_float(vals[54], vals[55], vals[56], vals[57]); data.allData[1] = data.pm25;
  data.pm10 = this->_calculate_float(vals[58], vals[59], vals[60], vals[61]); data.allData[2] = data.pm10;
